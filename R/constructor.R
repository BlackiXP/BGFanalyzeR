...
#' @param ReactorLayout A character vector providing the reactor layout, e.g. the grouping factor used for plotting and yield calculation of fermentation(s) in a BGF object
...
#' @param MeasurementType An optional character string indicating the measurement type of the BGF object to be created
#'
#'
